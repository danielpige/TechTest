...
BEGIN
    ...
    -- Validar coherencia jerárquica País -> Departamento -> Municipio
...
-- Rollback (manual)
-- ==========================================================
-- DROP PROCEDURE IF EXISTS sp_user_get_all(INT, INT, REFCURSOR);
-- DROP PROCEDURE IF EXISTS sp_user_delete(BIGINT);
-- DROP PROCEDURE IF EXISTS sp_user_update(BIGINT, VARCHAR, VARCHAR, VARCHAR, INT, INT, INT);
-- DROP PROCEDURE IF EXISTS sp_user_get_by_id(BIGINT);
-- DROP PROCEDURE IF EXISTS sp_user_create(VARCHAR, VARCHAR, VARCHAR, INT, INT, INT);
